...
<div class="mcmd-modal">
    <div class="mcmd-dialog">
        <div class="mcmd-header">
            <div class="mcmd-title"><?php esc_html_e("Select Role", 'mediacommander'); ?></div>
        ...
        <div class="mcmd-data">
            ...
            <p><?php esc_html_e("To create a new profile entry, select a registered WordPress role from the list below.", 'mediacommander'); ?></p>
