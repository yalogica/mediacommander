...
<div class="mcmd-modal">
    <div class="mcmd-dialog">
        <div class="mcmd-header">
            <div class="mcmd-title"><?php esc_html_e("Select Security", 'mediacommander'); ?></div>
        ...
        <div class="mcmd-data">
            ...
            <p><?php esc_html_e("Select a registered security role from the list below if you want to change it.", 'mediacommander'); ?></p>
